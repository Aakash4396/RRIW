...
__global__ void init_world(hittable_list** d_world) {
    ...
    *d_world = new hittable_list();
    ...
    (*d_world)->add(new sphere(point(0.0f, 0.0f, -1.0f), 0.5f, new lambertian(color(0.7, 0.3, 0.3))));
    (*d_world)->add(new sphere(point(-1.0f, 0.0f, -1.0f), 0.5f, new metal(color(0.8, 0.8, 0.8), 0.3)));

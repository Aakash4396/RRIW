...
__global__ void init_world(hittable_list** d_world) {
    ...
    *d_world = new hittable_list();
    (*d_world)->add(new sphere(point(0.0f, -100.5f, -1.0f), 100.0f, new lambertian(color(0.8, 0.8, 0.0))));
    (*d_world)->add(new sphere(point(0.0f, 0.0f, -1.0f), 0.5f, new lambertian(color(0.1, 0.2, 0.5))));
    (*d_world)->add(new sphere(point(-1.0f, 0.0f, -1.0f), 0.5f, new dielectric(1.5)));
    (*d_world)->add(new sphere(point(-1.0f, 0.0f, -1.0f), -0.4f, new dielectric(1.5)));
    (*d_world)->add(new sphere(point(1.0f, 0.0f, -1.0f), 0.5f, new metal(color(0.8, 0.6, 0.2), 0.1)));
}
